...
export default function EditRadicadoPage() {
  ...
  useEffect(() => {
    getAllRadications()
      ...
      .catch((e) => toast.error("Error al cargar radicado: " + e.message))
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success("Radicado actualizado correctamente", { id: toastId });
      ...
      <form className={styles.card} onSubmit={handleSubmit}>
        ...
        <div className={styles.formGrid}>
          ...
          <div className={`${styles.formGroup} ${styles.fullWidth}`}>
            ...
            <input type="text" name="referenciados" value={formData.referenciados} onChange={handleChange} className={styles.input} />
          </div>
        </div>
