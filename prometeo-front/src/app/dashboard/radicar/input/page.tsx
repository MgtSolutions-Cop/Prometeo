...
export default function RadicarEntradaPage() {
  ...
  const [formData, setFormData] = useState({
    // ── Fechas ──
    fecha_radicacion:      today,   // readonly — se guarda en metadata
    fecha_documento:       "",
      ...
      <form className={styles.card} onSubmit={handleSubmit}>
        ...
        <div className={styles.formGrid}>
          ...
          <div className={styles.formGroup}>
            ...
            <input
              type="text"
              name="no_origen"
              value={formData.no_origen}
              onChange={handleChange}
              className={styles.input}
              placeholder="Ej: 2024EE2345"
            />
          </div>
          ...
          <div className={styles.formGroup}>
            ...
            <input
              type="text"
              name="no_guia"
              value={formData.no_guia}
              onChange={handleChange}
              className={styles.input}
              placeholder="Ej: RE2024FT34TR"
            />
          </div>
          ...
          <div className={`${styles.formGroup} ${styles.fullWidth}`}>
            ...
            <input
              type="text"
              name="referenciados"
              value={formData.referenciados}
              onChange={handleChange}
              className={styles.input}
              placeholder="Números de radicados anteriores relacionados (ej: 1-2024-75, 1-2024-74)"
            />
          </div>
        ...
        <div className={styles.formGrid}>
          ...
          <div className={styles.formGroup}>
            ...
            <select required name="clase_correspondencia" value={formData.clase_correspondencia} onChange={handleChange} className={styles.select}>
          ...
          <div className={styles.formGroup}>
            ...
            <input type="text" name="direccion" value={formData.direccion} onChange={handleChange} className={styles.input} placeholder="Dirección del remitente" />
          </div>

          <div className={styles.formGroup}>
            <label className={styles.label}>Teléfono</label>
            <input type="tel" name="telefono" value={formData.telefono} onChange={handleChange} className={styles.input} placeholder="Teléfono del remitente" />
          </div>
          ...
          <div className={styles.formGroup} style={{ display: "flex", alignItems: "center", gap: 32, paddingTop: 28 }}>
            <label style={{ display: "flex", alignItems: "center", gap: 8, cursor: "pointer", fontSize: 14, color: "rgba(255,255,255,0.8)" }}>
              <input
                type="checkbox"
                name="aplica_confidencial"
                checked={formData.aplica_confidencial}
                onChange={handleChange}
            ...
            <label style={{ display: "flex", alignItems: "center", gap: 8, cursor: "pointer", fontSize: 14, color: "rgba(255,255,255,0.8)" }}>
              <input
                type="checkbox"
                name="llevado_a_la_mano"
                checked={formData.llevado_a_la_mano}
                onChange={handleChange}
                style={{ width: 16, height: 16, accentColor: "#E53935" }}
              />
              Llevado a la Mano
        ...
        <div className={styles.formGrid}>
          ...
          <div className={styles.formGroup}>
            ...
            <input type="text" name="jefe_dependencia" value={formData.jefe_dependencia} onChange={handleChange} className={styles.input} placeholder="Nombre del jefe de dependencia" />
          </div>

          <div className={styles.formGroup}>
            <label className={styles.label}>Encargado</label>
            <input type="text" name="encargado" value={formData.encargado} onChange={handleChange} className={styles.input} placeholder="Nombre del encargado" />
          </div>
        ...
        <div className={styles.formGrid}>
          ...
          <div className={`${styles.formGroup} ${styles.fullWidth}`}>
            ...
            <input required type="text" name="subject" value={formData.subject} onChange={handleChange} className={styles.input} placeholder="Resumen del contenido del documento" />
          </div>
